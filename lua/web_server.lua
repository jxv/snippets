...
local function reply(myserver, stream) -- luacheck: ignore 212
	...
	local rep_headers = http_headers.new()
	rep_headers:append(":status", "200")
	rep_headers:append("content-type", "application/json")
	-- Send headers to client; end the stream immediately if this was a HEAD request
	assert(stream:write_headers(rep_headers, req_method == "HEAD"))
